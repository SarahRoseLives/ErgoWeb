...
import 'package:ergoweb/main.dart'; // To access PendingNotification and the global onDidReceiveNotificationResponse
...
class NotificationService {
  ...
  Future<void> setupLocalNotifications() async {
    ...
    if (androidPlugin != null) {
      try {
        await androidPlugin.deleteNotificationChannel('ergoweb_channel_id');
    ...
    final AndroidNotificationChannel channel = AndroidNotificationChannel(
      'ergoweb_channel_id', // id
      'ergoweb Messages', // title
      description: 'Notifications for new ergoweb chat messages', // description
