...
import 'package:ergoweb/firebase_options.dart';
import 'package:ergoweb/main_layout.dart';
import 'package:ergoweb/screens/login_screen.dart';
import 'package:ergoweb/services/api_service.dart';
import 'package:ergoweb/services/encryption_service.dart';
import 'package:ergoweb/services/update_service.dart';
import 'package:ergoweb/services/websocket_service.dart';
import 'package:ergoweb/utils/web_check.dart';
import 'package:ergoweb/viewmodels/chat_state.dart';
// FingerprintGate import removed

import 'package:flutter_local_notifications/flutter_local_notifications.dart';
import 'package:ergoweb/services/notification_service_platform.dart'
...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  if (!kIsWeb && defaultTargetPlatform == TargetPlatform.android) {
    channel = AndroidNotificationChannel(
      'ergoweb_channel_id',
      'ergoweb Messages',
      description: 'Notifications for new ergoweb chat messages',
  ...
  if (title != null && body != null) {
    ...
    if (!kIsWeb && defaultTargetPlatform == TargetPlatform.android) {
      androidPlatformChannelSpecifics = AndroidNotificationDetails(
        'ergoweb_channel_id',
        'ergoweb Messages',
        channelDescription: 'Notifications for new ergoweb chat messages',
        importance: Importance.high,
...
Future<void> main() async {
  ...
  runApp(const ergowebApp());
}

class ergowebApp extends StatelessWidget {
  const ergowebApp({super.key});
...
class _AuthWrapperState extends State<AuthWrapper> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    if (_isLoggedIn && _username != null && _token != null) {
      return ergowebLayout(username: _username!, token: _token!);
    } else {
      return LoginScreen();
    }
  }
