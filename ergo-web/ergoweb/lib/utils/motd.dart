...
class Motd {
  static final List<String> _messages = [
    "Welcome to ergoweb — where your chat is yours.",
    ...
    "ergoweb: A rainbow in a gray sky, a message that you’re not forgotten.",
    "If the world feels heavy, let ergoweb help carry a little of it.",
    ...
    "ergoweb is more than software. It’s a soft place to land.",
