...
var Cfg = Config{
    ...
    TLSCertFile:          "/etc/letsencrypt/live/ergoweb.transirc.chat/fullchain.pem",
    TLSKeyFile:           "/etc/letsencrypt/live/ergoweb.transirc.chat/privkey.pem",
    TLSDomain:            "ergoweb.transirc.chat", // Your domain
